              ...
              {vertex,0,2,[],false,undefined,
                  {slave_vertex,
                      {expr_token,<<"maps:get(title, Bindings)">>,
                          ...
                          [title]}}},
          3 =>
              {vertex,0,3,[],false,undefined,
                  {slave_vertex,{text_token,<<"</title></head><body><ul>">>}}},
          4 => {vertex,0,4,[11,6,5],false,undefined,{master_vertex,undefined}},
          5 =>
              {vertex,4,5,[],false,undefined,
                  {slave_vertex,
                      {expr_token,<<"lists:map(fun(Item) ->">>,
                          ...
                          []}}},
          6 => {vertex,4,6,[10,9,8,7],false,undefined,{master_vertex,undefined}},
          7 =>
              {vertex,6,7,[],false,undefined,
